...
def _render_google_button(key: str = "google_login"):
    ...
    # The button triggers Javascript that breaks out of both the component iframe AND the site iframe.
    components.html(f'''
    <style>
    ...
    <div class="btn" onclick="window.top.location.href='{auth_url}'">
        <div class="logo"></div>
